...
1. Ve a: https://workhoops-club.preview.emergentagent.com/auth/register
...
### Panel Principal
```
https://workhoops-club.preview.emergentagent.com/admin
```

### Gestión de Ofertas
```
https://workhoops-club.preview.emergentagent.com/admin/opportunities
```
Aquí puedes:
...
```
https://workhoops-club.preview.emergentagent.com/admin/users
```
Aquí puedes ver:
