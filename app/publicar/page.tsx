...
import { ArrowLeft, Upload, MapPin, Users, Euro, Calendar, FileText, Shield, Loader2, TrendingUp, Target, CheckCircle2, BarChart3 } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* CTA Card */}
          <Card className="bg-gradient-to-r from-workhoops-primary to-workhoops-accent text-white">
            <CardContent className="p-12 text-center">
              <Shield className="w-16 h-16 mx-auto mb-4" />
              <h2 className="text-2xl font-bold mb-2">
                Regístrate para publicar ofertas
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/auth/login">
                  <Button variant="outline" size="lg" className="bg-white text-workhoops-primary hover:bg-gray-100 w-full sm:w-auto">
                    Iniciar sesión
                  </Button>
                </Link>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Informative Section - Only shown when NOT showing the form */}
        {(!session || session.user.role !== 'club' && session.user.role !== 'agencia') && (
          <>
            {/* Hero informativo */}
            <Card className="mb-8 bg-gradient-to-br from-orange-50 to-white border-workhoops-accent/20">
              <CardContent className="p-8">
