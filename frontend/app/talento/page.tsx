          ...
          <Card className="shadow-xl">
            ...
            <CardContent>
              <form className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div>
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="right">Diestra</SelectItem>
                          <SelectItem value="left">Zurda</SelectItem>
                          <SelectItem value="both">Ambidiestra</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
                ...
                {/* Experiencia */}
                <div>
                  <Label htmlFor="experience">Experiencia y logros</Label>
                  <Textarea 
                    id="experience"
                    placeholder="Describe tu experiencia, equipos en los que has jugado, logros destacados..."
                ...
                <div>
                  ...
                  <Textarea 
                    id="availability"
                    placeholder="Horarios disponibles, disponibilidad para viajar, fechas..."
                    className="mt-1"
                  />
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="highlights">Enlace a highlights (opcional)</Label>
                    <Input 
                      id="highlights" 
                      type="url"
                ...
                <div>
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-workhoops-accent transition-colors">
                    <div className="space-y-1 text-center">
                      <Upload className="mx-auto h-12 w-12 text-gray-400" />
                      <div className="flex text-sm text-gray-600">
                        <label htmlFor="profilePhoto" className="relative cursor-pointer bg-white rounded-md font-medium text-workhoops-accent hover:text-orange-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-workhoops-accent">
