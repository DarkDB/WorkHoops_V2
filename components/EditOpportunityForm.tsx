...
export default function EditOpportunityForm({ opportunity }: EditOpportunityFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    country: opportunity.country || 'España',
    ...
    remunerationType: opportunity.remunerationType || 'mensual',
    remunerationMin: opportunity.remunerationMin || '',
    remunerationMax: opportunity.remunerationMax || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/opportunities/${opportunity.slug}`, {
        method: 'PUT',
        headers: {
